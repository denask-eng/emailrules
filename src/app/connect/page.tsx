...
const GATES = [
  ...
  {
    n: "03",
    t: "Multi-client profiles (local)",
    d: "Agencies switch named programmes on this browser and print a client brief — no login theatre.",
    status: "Live now",
    live: true,
  },
  {
    ...
    d: "Compare your account settings to the rules that still need a person: tracking defaults, unsub behaviour, holdouts. No write access. No “AI score.”",
    status: "Not shipped",
    live: false,
  },
  {
    ...
    d: "Optional alert when SPF, DKIM, or DMARC on a domain you care about changes. Email-only, low noise.",
    status: "Not shipped",
    live: false,
  },
] as const;
